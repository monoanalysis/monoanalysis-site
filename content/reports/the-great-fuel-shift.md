...
subtitle: "Coal fell from 51% of US generation to 16%. Gas took the lead at 40.5%. Wind and solar reached 17.7% combined. EIA data, 2001 to 2026, with the STEO view to 2027."
date: "2026-07-08"
tags: ["Power", "Gas"]
featured: true
summary: "A read of US net electricity generation from EIA Monthly Energy Review Table 7.2a, January 2001 to March 2026, extended to 2027 with the EIA Short-Term Energy Outlook. Coal's share fell by two-thirds while natural gas nearly tripled and took the lead. Wind and solar reached 17.7% combined. Gas absorbed most of what coal gave up, with wind and solar taking the rest. The report covers the fuel mix, the crossovers, growth rates, seasonal peaks and troughs, what replaced coal, and the forecast to 2027."
---
...
Each fuel concentrates its output in different months. Coal and gas both peak in July, near 11% of their own annual output, and bottom in April as mild weather cuts load. Solar swings widest, from 11.3% in July to 4.8% in January. Wind runs opposite, highest in March and lowest in September. Hydro peaks in May on snowmelt. Nuclear is the steadiest fuel, moving only from 9.1% in December to 7.3% in April during maintenance season.

## Who Replaced Coal

![Who replaced coal](/images/fuel_shift_who_replaced_coal.png)

Coal lost 31.9 points of share between 2007 and 2025. Gas took the largest piece of that ground, gaining 19.2 points. Wind added 9.7 and solar 6.7. Nuclear, hydro, and other fuels each slipped slightly. Gas covered most of the decline on its own, and wind and solar together covered nearly half.
