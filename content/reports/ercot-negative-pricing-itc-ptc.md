...
Pearson r = 0.81 against renewable capacity, with roughly 9.1 additional negative hours per GW added. The relationship is not perfect, since congestion and weather add noise year to year, but the direction is unambiguous.
