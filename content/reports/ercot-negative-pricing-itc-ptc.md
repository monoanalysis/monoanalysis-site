...
Pearson r = 0.81 against renewable capacity, with roughly 9.1 additional negative hours per GW added.
...
For developers, the NPV model is decisive. PTC is the better election at capacity factors above 22% when negative exposure stays below 12 to 15% of annual hours. West Texas is already at 2 to 5% and rising. The ITC election is not conservative. At high negative exposure, it is simply the higher NPV outcome.